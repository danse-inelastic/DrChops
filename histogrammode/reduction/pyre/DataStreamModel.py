...
class DataStreamModel(Connectable):
    ...
    def __init__(self, name, facility='DataStreamModel'):
    ...
    def _configure(self):
        ...
        connections = self.inventory.connections
...
def main():
    ...
    class DSMExample(DataStreamModel):
        ...
        class Inventory(DataStreamModel.Inventory):

            import pyre.inventory as pinv
            
            connections = pinv.list(
                'connections',
                default = [
