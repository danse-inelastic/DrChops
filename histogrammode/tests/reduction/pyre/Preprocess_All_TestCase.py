...
class Preprocess_All_TestCase(TestCase):
        ...
        class Test(Script):
            ...
            class Inventory( Script.Inventory ):
                ...
                preprocess = inv.facility(
                    'preprocess', factory = Preprocess_All )
    ...
    pass # end of Preprocess_All_TestCase

    
def pysuite():
    suite1 = unittest.makeSuite(Preprocess_All_TestCase)
