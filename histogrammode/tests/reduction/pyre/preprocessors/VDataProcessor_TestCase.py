...
from reduction.pyre.preprocessors.VDataProcessor import VDataProcessor 


import unittestX as unittest

class VDataProcessor_TestCase(unittest.TestCase):
...
def pysuite():
    suite1 = unittest.makeSuite(VDataProcessor_TestCase)
...
# version
__id__ = "$Id: VDataProcessor_TestCase.py 1300 2007-07-09 14:14:07Z linjiao $"
