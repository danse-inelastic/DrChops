...
from reduction.vectorCompat.SubtractErrorProp import SubtractErrorPropagator


def test_0( **kwds):

    prop = SubtractErrorPropagator()
...
# version
__id__ = "$Id: vectorCompatTest_SubtractErrorProp.py 1099 2006-08-13 03:03:00Z linjiao $"
