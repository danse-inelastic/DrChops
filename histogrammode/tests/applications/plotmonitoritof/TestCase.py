...
class Tests(unittest.TestCase):
    ...
    def test1(self):
        "plotmonitoritof - lrmecs, monitor id=0"
        cmd = '''plotmonitoritof.py -instrument=lrmecs -lrmecs.filename="../../ins-data/Lrmecs/4849" -monitor-id=0 '''
    ...
    def test2(self):
        "plotmonitoritof - lrmecs, monitor id =1"
        cmd = '''plotmonitoritof.py -instrument=lrmecs -lrmecs.filename="../../ins-data/Lrmecs/4849" -monitor-id=1 '''
