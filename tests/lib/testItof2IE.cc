...
#include "drchops/Itof2IE.h"


void test();
void test2();
void test_Tof2EFunctor();
...
void test_Tof2EFunctor()
{
  ...
  Tof2EFunctor<double>  f( ei, mod2sample, sample2det );
  std::cout << "e = " << e << std::endl;
  assert (e == f(tof));
  assert (e < 3. && e > -3.);
  std::cout << "test_Tof2EFunctor done." << std::endl;
}
...
void test()
{
  ...
  Itof2IE<double, const double *, const double *,
    double *, double *> \
