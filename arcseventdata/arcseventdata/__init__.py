...
def write_mslice_files( IpE, phi_p, psi_p, dphi_p, dpsi_p, spefile, phxfile, mask_p=None):
    from mslice_spe_writer import writer
    writer.write_spe( IpE, phi_p, spefile, mask_p=mask_p)
    writer.write_phx( phi_p, psi_p, dphi_p, dpsi_p, phxfile, mask_p=mask_p)
    return
...
from events2IpdpEi import events2IpdpEi
