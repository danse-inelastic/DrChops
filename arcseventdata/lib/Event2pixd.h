...
#ifndef H_ARCSEVENTDATA_EVENT2PIXD
#define H_ARCSEVENTDATA_EVENT2PIXD
...
namespace ARCS_EventData{
  ...
  class Event2pixd: public Event2Quantity2<unsigned int, double>
  {
  public:
    // meta methods
    /// ctor.
...
#endif // H_ARCSEVENTDATA_EVENT2PIXD
