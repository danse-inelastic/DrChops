...
#ifndef REDUCTIONMODULE_NUMPY_SUPPORT_H
#define REDUCTIONMODULE_NUMPY_SUPPORT_H
...
std::ostream &  operator <<
  ( std::ostream & os, const reductionmod::Array1DIterator<ValueType> & it )
{
  it.print(os);
  return os;
}

#endif  // REDUCTIONMODULE_NUMPY_SUPPORT_H
